...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_website', (
            ...
            ('base_URL', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('series', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Serie'], blank=True)),
            ('filterset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Filterset'], blank=True)),
        ))
