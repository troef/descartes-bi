...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Namespace.view_dash'
        db.add_column(u'common_namespace', 'view_dash',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dashboard.Dash'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Namespace.view_dash'
        db.delete_column(u'common_namespace', 'view_dash_id')
